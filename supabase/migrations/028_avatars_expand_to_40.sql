-- ============================================================
-- Migration 028: Expansión a 40 avatares estáticos
-- Alinea la tabla public.avatars (ids 1..40) con los 40 archivos PNG
-- en src/assets/avatar/, usando style='static' (image_url=NULL; el
-- cliente resuelve la imagen por avatar_id vía registro Vite).
-- ============================================================
